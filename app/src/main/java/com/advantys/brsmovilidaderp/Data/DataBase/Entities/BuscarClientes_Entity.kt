...
data class BuscarClientes_Entity(
    ...
    companion object{
        ...
        fun fromCursor(cursor: Cursor): BuscarClientes_Entity {
            var modelo = BuscarClientes_Entity()
            modelo.nClientes =
                cursor.getInt((cursor.getColumnIndexOrThrow(BuscarClientes_Schema.CLIENTE_FIELD)))
            modelo.nombre =
                cursor.getString((cursor.getColumnIndexOrThrow(BuscarClientes_Schema.NOMBRE_FIELD)))
            modelo.direccion =
                cursor.getString((cursor.getColumnIndexOrThrow(BuscarClientes_Schema.DIRECCION_FIELD)))
            modelo.codPostal =
                cursor.getString((cursor.getColumnIndexOrThrow(BuscarClientes_Schema.CODIGOPOSTAL_FIELD)))
            modelo.provincia =
                cursor.getString((cursor.getColumnIndexOrThrow(BuscarClientes_Schema.PROVINCIA_FIELD)))
            modelo.poblacion =
                cursor.getString((cursor.getColumnIndexOrThrow(BuscarClientes_Schema.POBLACION_FIELD)))
            return modelo
        }
