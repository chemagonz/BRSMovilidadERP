...
class Series_Schema {
    companion object{
        ...
        const val ULTFACTURA_FIELD= "NULTFACTURA"
        const val CENTRO_FIELD= "NCENTRO"
        const val APLICAIVA_FIELD= "CAPLICAIVA"
        const val PEDIDO_FIELD= "LPEDIDO"
        const val ALBARAN_FIELD = "LALBARAN"
        const val FACTURA_FIELD= "LFACTURA"
