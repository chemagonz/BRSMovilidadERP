...
class FiltrarArticulos_Activity : AppCompatActivity() {
    ...
    private fun mostrarFamilias() {
        ...
        binding.autocompleteFamilia.setOnItemClickListener { parent, view, position, id ->
            ...
            Toast.makeText(applicationContext, "Código: ${elementoSeleccionado.familia}, Nombre: ${elementoSeleccionado.nombre}", Toast.LENGTH_SHORT).show()

            familiaID = elementoSeleccionado.familia
            elementoSeleccionado.nombre?.let { guardarItemSeleccionados(it, KEY_SELECTED_FAMILIA) }
    ...
    private fun mostrarSubfamilias() {
        ...
        binding.autocompleteSubfamilia.setOnItemClickListener { parent, view, position, id ->
            ...
            Toast.makeText(applicationContext, "Código: ${elementoSeleccionado.subfamilia}, Nombre: ${elementoSeleccionado.nombre}", Toast.LENGTH_SHORT).show()
            subfamiliaID = elementoSeleccionado.subfamilia
            elementoSeleccionado.nombre?.let { guardarItemSeleccionados(it,KEY_SELECTED_SUBFAMILIA) }
        }
    }
    ...
    private fun mostrarFormato() {
        ...
        binding.autocompleteFormato.setOnItemClickListener { parent, view, position, id ->
            ...
            Toast.makeText(applicationContext, "Código: ${elementoSeleccionado.formato}, Nombre: ${elementoSeleccionado.nombre}", Toast.LENGTH_SHORT).show()
            formatoID = elementoSeleccionado.formato
            elementoSeleccionado.nombre?.let { guardarItemSeleccionados(it, KEY_SELECTED_FORMATO) }
        }
    }
    ...
    private fun mostrarMarcas() {
        ...
        binding.autocompleteMarca.setOnItemClickListener { parent, view, position, id ->
            ...
            Toast.makeText(applicationContext, "Código: ${elementoSeleccionado.marca}, Nombre: ${elementoSeleccionado.nombre}", Toast.LENGTH_SHORT).show()
            marcaID= elementoSeleccionado.marca
            elementoSeleccionado.nombre?.let { guardarItemSeleccionados(it, KEY_SELECTED_MARCA) }
        }
    }

    private fun mostrarSabores() {
        ...
        binding.autocompleteSabor.setOnItemClickListener { parent, view, position, id ->
            ...
            Toast.makeText(applicationContext, "Código: ${elementoSeleccionado.sabor}, Nombre: ${elementoSeleccionado.nombre}", Toast.LENGTH_SHORT).show()
            saborID = elementoSeleccionado.sabor
            elementoSeleccionado.nombre?.let { guardarItemSeleccionados(it, KEY_SELECTED_SABOR) }
        }
    }
